...
struct NativeWebView: UIViewRepresentable {
    ...
    (function() {
      ...
      if (!document.getElementById('native-ios-shell-style')) {
        ...
        style.textContent = '.bottom-nav{display:none!important}.app-shell{max-width:100%!important;box-shadow:none!important}.screen{padding-bottom:calc(94px + env(safe-area-inset-bottom))!important}.auth-shell .screen{padding-bottom:calc(20px + env(safe-area-inset-bottom))!important}';
